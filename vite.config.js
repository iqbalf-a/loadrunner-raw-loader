...
export default defineConfig({
  ...
  server: {
    ...
    // Runtime data, bukan source — watch file yang sedang dikunci/ditulis (WAL DuckDB, upload ZIP) bikin crash EBUSY di Windows.
    watch: {
      ignored: ["**/.loadrunner-cache/**", "**/.loadrunner-uploads/**"],
    },
  },
  build: {
    rollupOptions: {
